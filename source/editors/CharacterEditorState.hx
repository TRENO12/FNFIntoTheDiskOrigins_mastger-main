...
class CharacterEditorState extends MusicBeatState
{
	...
	var libraryInputText:FlxUIInputText;
	...
	function addCharacterUI() {
		...
		imageInputText = new FlxUIInputText(15, 30, 200, 'characters/bf/BFsonic', 8);

		libraryInputText = new FlxUIInputText(-155, 30, 200, 'disk', 8);
		var reloadImage:FlxButton = new FlxButton(imageInputText.x + 210, imageInputText.y - 3, "Reload Image", function()
		{
			char.imageFile = imageInputText.text;
			char.libraryFile = libraryInputText.text;
			reloadCharacterImage();
		...
		tab_group.add(new FlxText(15, libraryInputText.y - 18, 0, 'Library file name:'));
		...
		tab_group.add(libraryInputText);
	...
	function reloadCharacterImage() {
		...
		if(Paths.fileExists('images/' + char.imageFile + '/Animation.json', TEXT)) {
			...
			char.frames = Paths.getSparrowAtlas(char.imageFile, char.libraryFile);
		}
